create database if not exists 12306_order_0 CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci';
...
(
    ...
    `pre_order_sn`   varchar(64) COLLATE utf8mb4_unicode_ci  DEFAULT NULL COMMENT '改签订单号',
...
create database if not exists 12306_order_1 CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci';
USE 12306_order_1;
